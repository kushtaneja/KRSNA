...
class BooksTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let category: category = booksArray[indexPath.row]
    ...
    func insertVideoCategories(){
        ...
        let vrindavan_head = ref.child("new_books").child("list").queryOrderedByKey().observe(.childAdded, with:  { (snapshot) in
            ...
            self.booksArray.append(currentCategory)
